...
<head>
  ...
  <link href="<?= base_url() ?>/public/home/assets/app.png" rel="shortcut icon" type="image/x-icon" />
  ...
  <link href="<?= base_url() ?>/public/home/css/index.css" rel="stylesheet" />
  <title>Privacy Policy Symptomed</title>
</head>

<body><!-- HEADER -->
  <header class="header">
    <nav class="header__nav">
      <div class="container header__container"><!-- Logo --><a href="#"><img alt="SymptoMed logo" class="header__logo" src="<?= base_url() ?>/public/home/assets/logo-company.png" /> </a> <!-- Header links -->
        <div class="header__links">
          <ul class="header__links-container">
            ...
            <li><a class="header__play-store" href="https://play.google.com/store/apps/details?id=id.symptomed.symptomed"><img alt="Google Play" src="<?= base_url() ?>/public/home/assets/cta-google-play-color.svg" /> </a></li>
          </ul>
        </div>
        <!-- Header cta --> <a class="header__play-store" href="https://play.google.com/store/apps/details?id=id.symptomed.symptomed"> <img alt="Google Play" src="<?= base_url() ?>/public/home/assets/cta-google-play-color.svg" /> </a> <!-- Burger menu --><button class="header__burger-button" type="button"><img alt="Mobile menu button" src="<?= base_url() ?>/public/home/assets/icon-burger-menu.svg" /></button>
      </div>
    </nav>
  </header>
  ...
  <section class="objectives">
    <div class="container objectives__container">
      <div class="objectives__copy"><img alt="" src="<?= base_url() ?>/public/home/assets/icon-quote-mark.svg" />
        <h2>Privacy Policy</h2>
      </div>

      <div class="objectives__group"><!-- Interpretation and Definitions -->
        <article class="objectives__vision">
          <h3>Notes</h3>

          <div><img alt="" src="<?= base_url() ?>/public/home/assets/icon-quote-mark.svg" />
              ...
              <div class="accordion__collapse">
                <div class="accordion__body">
                  ...
                  <ol>
                    ...
                    <li>
                      <p><strong>Application</strong> refers to SymptoMed, the software program provided by the Company.</p>
                    </li>
                    <li>
                      <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SymptoMed, Bekasi, West Java.</p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p><strong>Website</strong> refers to SymptoMed, accessible from <a href="https://symptomed.id/" rel="external nofollow noopener" target="_blank">https://symptomed.id/</a></p>
                    </li>
                    <li>
        ...
        <article class="objectives__mission">
          ...
          <div class="accordion">
            ...
            <div class="accordion__item">
              <button type="button" class="accordion__button">
                <h4 class="accordion__question">Retention of Your Personal Data</h4>
                <div class="accordion__icon">
            ...
            <div class="accordion__item">
              <button type="button" class="accordion__button">
                <h4 class="accordion__question">Transfer of Your Personal Data</h4>
                <div class="accordion__icon">
                  <img src="<?= base_url() ?>/public/home/assets/icon-expand.svg" alt="Accordion button icon" />
                </div>
              </button>
            ...
            <div class="accordion__item">
              <button type="button" class="accordion__button">
                <h4 class="accordion__question">Delete Your Personal Data</h4>
                <div class="accordion__icon">
                  <img src="<?= base_url() ?>/public/home/assets/icon-expand.svg" alt="Accordion button icon" />
                </div>
              </button>
            ...
            <div class="accordion__item">
              <button type="button" class="accordion__button">
                <h4 class="accordion__question">Disclosure of Your Personal Data</h4>
                <div class="accordion__icon">
                  <img src="<?= base_url() ?>/public/home/assets/icon-expand.svg" alt="Accordion button icon" />
                </div>
              </button>
            ...
            <div class="accordion__item">
              <button type="button" class="accordion__button">
                ...
                <div class="accordion__icon">
                  <img src="<?= base_url() ?>/public/home/assets/icon-expand.svg" alt="Expand icon" />
                  <!-- <img
            src="<?= base_url() ?>/public/home/assets/icon-collapse.svg" alt="Collapse icon" /> -->
                </div>
              </button>
              <div class="accordion__collapse">
                <div class="accordion__body">
        ...
        <article class="objectives__vision">
          ...
          <div><img alt="" src="<?= base_url() ?>/public/home/assets/icon-quote-mark.svg" />
            <p>Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. If You are a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. If We become aware that We have collected Personal Data from anyone under the age of 13 without verification of parental consent, We take steps to remove that information from Our servers.
              ...
              <br><br>If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent's consent before We collect and use that information.
            </p>
          </div>
          ...
          <div><img alt="" src="<?= base_url() ?>/public/home/assets/icon-quote-mark.svg" />
            <p>If you have any questions about this Privacy Policy, You can contact us:<br>
              By Email : support@symptomed.id<br>
              By Phone number: +6285783992232<br>
            </p>
            </ul>
          </div>
        </article>
  ...
  <section class="cta">
    <div class="cta__copy-container">
      <div class="container cta__copy">
        ...
        <a href="https://play.google.com/store/apps/details?id=id.symptomed.symptomed"><img alt="Get on Google Play icon" src="<?= base_url() ?>/public/home/assets/cta-google-play-color.svg" /> </a>
      </div>
    </div>

    <div class="cta__app-preview"><img alt="SymptoMed mobile app preview" src="<?= base_url() ?>/public/home/assets/cta-mobile-app-preview.png" /></div>
  </section>
  <!-- SLOGAN -->
  ...
  <footer class="footer">
    <div class="container footer__container">
      <div class="footer__company"><img alt="SymptoMed logo" class="footer__logo" src="<?= base_url() ?>/public/home/assets/logo-company.png" />
        ...
        <div class="footer__supporters">
          ...
          <ul>
            <li><img alt="Bangkit logo" src="<?= base_url() ?>/public/home/assets/logo-bangkit.png" /></li>
            <li><img alt="Google logo" src="<?= base_url() ?>/public/home/assets/logo-google.png" /></li>
            <li><img alt="Ristekdikti logo" src="<?= base_url() ?>/public/home/assets/logo-ristekdikti.png" /></li>
          </ul>
        </div>
      </div>

      <div class="footer__links"><!-- Links grop 1 -->
    ...
    <div class="footer__links-group">
        ...
        <div class="footer__links-group">
          ...
          <ul>
            ...
            <li><a class="footer__link" href="https://www.linkedin.com/company/symptomed">LinkedIn</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <script src="<?= base_url() ?>/public/home/app/js/sweetAlert2.js"></script>
</body>
