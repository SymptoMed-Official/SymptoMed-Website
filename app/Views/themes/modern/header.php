...
<link rel="stylesheet" id="style-switch-bootswatch" type="text/css" href="<?=$config->baseURL . 'public/vendors/bootswatch/'. ( $theme_mode == 'light' ? $app_layout['bootswatch_theme'] : 'default' ) .'/bootstrap.min.css?r='.time()?>"/>
