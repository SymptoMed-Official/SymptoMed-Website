...
<body>
	...
	<header class="shadow-sm">
		<div class="menu-wrapper wrapper clearfix">
			...
			<div class="nav-left">
				<a href="" class="logo-header" title="SymptoMed">
					<img src="<?=$config->baseURL?>public/images/logo_login.png" alt="SymptoMed"/>
				</a>
			</div>
		...
		<div class="wrapper">
			<div class="row mb-0">
				...
				<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 mb-2">
					...
					<ul class="list">
						<li><i class="fab fa-facebook-square me-2"></i><a href="https://web.facebook.com/SymptoMed" target="_blank">facebook</a></li>
					</ul>
				</div>
