...
class EdukasiModel extends \App\Models\BaseModel
{
    ...
    public function setData($id_artikel, $where)
    {
        ...
        return [
            'artikel' => $artikel, 'ref_author' => $ref_author, 'ref_kategori' => $ref_kategori, 'id_kategori' => $id_kategori, 'artikel_kategori' => $artikel_kategori, 'id_author' => $id_author, 'artikel_author' => $artikel_author, 'id_artikel' => $id_artikel, 'feature_image' => $feature_image
        ];
    }
